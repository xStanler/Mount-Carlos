...
class MainMenu():
    def __init__(self, screen_width, screen_height):
        ...
        self.howtoplay_button = Button("JAK GRAĆ?", btn_x, 410, btn_w, btn_h, (60, 82, 60), (51, 71, 51), self.button_font)
        self.quit_button = Button("WYJDŹ", btn_x, 490, btn_w, btn_h, (60, 82, 60), (51, 71, 51), self.button_font)
    ...
    def update(self, mouse_pos, mouse_clicked):
        ...
        self.howtoplay_button.update(mouse_pos)
        ...
        if self.settings_button.is_clicked(mouse_pos, mouse_clicked):
            return "SETTINGS"
        if self.howtoplay_button.is_clicked(mouse_pos, mouse_clicked):
            return "HOWTOPLAY"
    ...
    def render(self, screen):
        ...
        self.howtoplay_button.set_position((self.screen_width // 2) - (240 // 2), 410)
        self.quit_button.set_position((self.screen_width // 2) - (240 // 2), 490)
        self.title_rect = self.title_surf.get_rect(center=(self.screen_width // 2, 120))
        ...
        self.howtoplay_button.draw(screen)
